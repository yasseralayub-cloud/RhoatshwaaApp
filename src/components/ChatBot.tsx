              ...
              <div className="flex gap-2.5 items-center">
                ...
                <div>
                  <h5 className="text-[11px] font-black text-yellow leading-tight">
                    {language === 'ar' ? 'مساعد رحلة شواء الذكي' : 'Rehla BBQ Smart Helper'}
                  </h5>
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
              ...
              <div className="flex items-center gap-3 z-10 text-start">
                ...
                <div>
                  <h4 className="text-sm font-black tracking-wide text-white">
                    {language === 'ar' ? 'مساعد رحلة شواء الذكي' : 'Rehla BBQ Smart Assistant'}
                  </h4>
            ...
            {/* AI Assistant Disclaimer Note */}
            <div className="bg-slate-50/80 px-3 py-1.5 border-t border-slate-100 text-center shrink-0">
              <p className="text-[10px] text-slate-400 leading-tight font-medium">
                {language === 'ar' 
                  ? '⚠️ تنبيه: المعلومات الواردة هنا قد لا تكون دقيقة تماماً، وهي مولدة تلقائياً بالذكاء الاصطناعي لمساعدتكم.' 
                  : '⚠️ Note: Information here might not be fully accurate. It is auto-generated by AI to assist you.'}
              </p>
            </div>
          </motion.div>
        )}
